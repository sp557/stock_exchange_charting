...
class CreateExchangeComponent extends Component {
    constructor(props) {
        super(props)
    ...
    saveExchange = (e) => {
        ...
        ExchangeService.createExchange(exchange).then(res =>{
                ...
                <br></br>
                   <div className = "container">
                        <div className = "row">
                            ...
                            <h3 className="text-center">Add Exchange</h3>
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.saveExchange}>Save</button>
